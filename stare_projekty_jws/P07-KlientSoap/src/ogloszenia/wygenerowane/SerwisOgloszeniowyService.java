 ...
 * 
 */
@WebServiceClient(name = "SerwisOgloszeniowyService", targetNamespace = "http://soap.ogloszenia/", wsdlLocation = "http://localhost:8080/P06-OgloszeniaSoap-1.0/SerwisOgloszeniowy?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/P06-OgloszeniaSoap-1.0/SerwisOgloszeniowy?wsdl");
