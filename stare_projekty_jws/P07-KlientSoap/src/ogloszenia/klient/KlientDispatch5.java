...
import ogloszenia.wygenerowane.JednoOgloszenie;
...
public class KlientDispatch5 {
	...
	public static void main(String[] args) {
		...
		JednoOgloszenie zapytanie = new JednoOgloszenie();
		zapytanie.setId(3);
		
		try {
			JAXBContext ctx = JAXBContext.newInstance(JednoOgloszenie.class);
