...
// Tak też działało - jeśli parametr {id} jest na poziomie klasy, to metody mogą odwoływać się do niego za pomocą @PathParam

@Path("/ogloszenia_inna_wersja/{id}")
@Produces("application/json")
@Consumes("application/json")
public class ROgloszenie_InnaWersja {
