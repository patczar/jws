...
public class ROgloszenia {
	...
	// @GET
	// Metoda ogloszeniaWgCeny realizuje funkcjonalność tej metody jeśli nie poda się parametrów.
	// Aby wywołanie było jednoznaczne zostawiam adnotację GET tylko przy jednej z nich: tej bardziej ogólnej
	...
	/* Tutaj nie używamy metody PUT, ponieważ zapiszOgloszenie może dodawać nowe ogłoszenia
	 * - w tej sytuacji klient nie zna z góry adresu, pod którym ogłoszenie zostanie zapisane.
	 * 
	 * PUT powinien być używany wtedy, gdy klient wie pod jakim adresem chce zapisać dane wysyłane przez siebie.
	 */
	@POST
