 ...
 * generated in the zad12.sklep package. 
...
public class ObjectFactory {
    ...
    private final static QName _TTekstBr_QNAME = new QName("urn:sklep", "br");
    private final static QName _TTekstRem_QNAME = new QName("urn:sklep", "rem");
    private final static QName _TTekstEm_QNAME = new QName("urn:sklep", "em");
    private final static QName _TTekstTerm_QNAME = new QName("urn:sklep", "term");
    private final static QName _TTekstLink_QNAME = new QName("urn:sklep", "link");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: zad12.sklep
     * 
     */
    ...
    /**
     * Create an instance of {@link Towar.CenaPromocyjna }
     * 
     */
    public Towar.CenaPromocyjna createTowarCenaPromocyjna() {
        return new Towar.CenaPromocyjna();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:sklep", name = "br", scope = TTekst.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:sklep", name = "rem", scope = TTekst.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:sklep", name = "em", scope = TTekst.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:sklep", name = "term", scope = TTekst.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:sklep", name = "link", scope = TTekst.class)
