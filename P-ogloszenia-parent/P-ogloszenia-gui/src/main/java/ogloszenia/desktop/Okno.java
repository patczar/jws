...
public class Okno {
	...
	public Okno() {
		try {
			...
			e.printStackTrace();
			JOptionPane.showMessageDialog(null, "Nie można połączyć się z bazą,\nprogram zostanie przerwany", "Problem", JOptionPane.ERROR_MESSAGE);
			System.exit(0);
		}
		initialize();
	}
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 840, 800);
				...
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								.addComponent(txtTytul, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE)
								.addComponent(txtMarka, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE)))
						.addGroup(gl_panel.createSequentialGroup()
							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
							...
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								.addComponent(txtCena, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE)
								.addComponent(txtModel, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))))
	...
	private void pobierzDane(int idOgloszenia) {
		...
		try {
			...
			biezaceOgloszenie = dao.odczytajWgId(idOgloszenia);
			try {
				byte[] bajtyZeZdjeciem = FotoUtil.wczytajFoto(idOgloszenia);
