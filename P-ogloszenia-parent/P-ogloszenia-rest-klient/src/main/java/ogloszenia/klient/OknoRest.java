...
public class OknoRest {
	private IOgloszenia port;
	...
	public OknoRest() {
		...
		port = target.proxy(IOgloszenia.class);
		initialize();
	}
	...
	private void pobierzDane(int idOgloszenia) {
		...
		try {
			...
			biezaceOgloszenie = port.jednoOgloszenie(idOgloszenia);
			try {
