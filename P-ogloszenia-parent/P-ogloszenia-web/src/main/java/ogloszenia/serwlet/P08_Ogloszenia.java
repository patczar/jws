...
@WebServlet({"/P08_Ogloszenia", "/ogloszenia.html"})
public class P08_Ogloszenia extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("WEB-INF/J08_Ogloszenia.jsp");
			if(dispatcher != null) {
